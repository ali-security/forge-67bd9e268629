  ...
  describe('x509', function() {
    ...
    it('should require basicConstraints on non-leaf certificates', function() {
      ...
      function generateKeyPair() {
        // 512 bits is enough to sign/verify this chain and keeps the pure
        // JavaScript key generation used by older node versions fast
        return PKI.rsa.generateKeyPair({bits: 512, e: 0x10001});
      }
